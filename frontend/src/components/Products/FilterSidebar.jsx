...
const FilterSidebar = () => {
    ...
    const handleFilterChange = (e) =>{
        ...
        if(type === "checkbox"){
            if(checked){
                newFilters[name] = [...(newFilters[name] || []),value]; // append the existing array
            }else{
    ...
    const handlePriceChange =(e)=>{
        ...
        let newFilters = {...filters, minPrice: 0, maxPrice: newPrice };
        setFilters(filters);
        updateURLParams(newFilters)
    }
     ...
     <div className="mb-6">
        ...
        {sizes.map((size)=>(
            <div key={size} className='flex items-center mb-1 '>
                ...
                name="size" className='mr-2 h-4 w-4 text-blue-500 
     ...
     <div className="mb-6">
        ...
        {materials.map((material)=>(
            <div key={material} className='flex items-center mb-1 '>
                ...
                name="material" className='mr-2 h-4 w-4 text-blue-500 
                focus:ring-blue-400 border-gray-300 '/>
     ...
     <div className="mb-6">
        ...
        {brands.map((brand)=>(
            <div key={brand} className='flex items-center mb-1 '>
                ...
                name="brand" className='mr-2 h-4 w-4 text-blue-500 
                focus:ring-blue-400 border-gray-300 '/>
