        ...
        <div className="bg-white rounded-lg p-6 ">
            ...
            <form action="" onSubmit={handleCreateCheckout}>
                ...
                <div className="mb-4">
                    ...
                    <input type="email" value={user?user.email:""} className='p-2 border rounded'
                    disabled/>
                </div>
                ...
                {cart.products.map((product,index)=>(
                    <div key={index} className='flex items-start justify-between py-2 border-b'>
                        <div className='flex items-start'>
                            <img src={`${import.meta.env.VITE_BACKEND_URL}${product.image}`} alt={product.name} className='w-20 h-24 object-cover mr-4 ' />
                            <div>
